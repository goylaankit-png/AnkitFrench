...
export default function FrenchVocabApp() {
  ...
  const speak = (text) => {
    ...
    const audio = new Audio(`https://translate.google.com/translate_tts?ie=UTF-8&q=${encoded}&tl=fr&client=tw-ob`);
    audio.play().catch(() => {
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <div>
                        ...
                        <button onClick={(e) => { e.stopPropagation(); speak(word.french); }} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 16, padding: "0 4px", opacity: 0.7 }} title="Listen">🔊</button>
