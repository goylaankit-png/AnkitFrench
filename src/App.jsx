          ...
          <div>
            ...
            {addMode === "bulk" && !editId && (
              <div style={{ background: "#fff", borderRadius: 16, padding: 22, boxShadow: "0 2px 12px rgba(0,0,0,0.08)", marginBottom: 14 }}>
                ...
                <textarea value={bulkText} onChange={e => setBulkText(e.target.value)} placeholder={"le soleil
la lune
la forêt
le printemps"} rows={8} style={{ width: "100%", padding: "10px 13px", border: "2px solid #e0d8cc", borderRadius: 8, fontSize: 14, fontFamily: "Georgia,serif", boxSizing: "border-box", resize: "vertical" }} />
                {bulkProcessing && (
